...
public class CustomFieldsUtils extends BaseClass {
	...
	public void clickOnCustomFields() {
		seleniumCore.clickOnSubMenu(driver.findElement(By.xpath(ReuseLocators.menu("Configuration"))),driver.findElement(By.xpath(ReuseLocators.menuLink("Custom Fields"))));
	}

package com.module.utils.leave.reports;
...
public class MyLeaveEntitlementsAndUsageReportUtils extends BaseClass {
	
	public SeleniumCore seleniumCore;
	public SeleniumUtils seleniumUtils;
	public WaitTime waitTime;
	
	public MyLeaveEntitlementsAndUsageReportUtils() {
